                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pno" type="text" class="form-control @error('pno') is-invalid @enderror" name="pno" value="{{ old('pno') }}" required autocomplete="pno">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dob" type="text" class="form-control @error('dob') is-invalid @enderror" name="dob" value="{{ old('dob') }}" required autocomplete="dob" readonly>
